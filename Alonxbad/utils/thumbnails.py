...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("Aloxbad/assets/font2.ttf", 30)
        font = ImageFont.truetype("Aloxbad/assets/font.ttf", 30)
        title_font = ImageFont.truetype("Aloxbad/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("Aloxbad/assets/play_icons.png")
